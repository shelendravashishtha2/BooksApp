      ...
      children: [
        Positioned(
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.only(topLeft: Radius.circular(200.0),topRight: Radius.circular(0.0),),
              ),
            width: width,
            height: height,
          ),
        ...
        Positioned(
          ...
          child: PaddingButtons(
            text: 'Log In',
            onpressed: (){
              pageControl.animateToPage(1, duration: Duration(seconds:1), curve: Curves.linear);
            },
          ),
        ),
        Positioned(
